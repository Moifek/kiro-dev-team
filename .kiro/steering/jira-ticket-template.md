...
# Jira Ticket Template - Your Org Engineering

Standard structure for creating and updating Jira tickets across PROJ2 and PROJ boards.
...
### ⚠️ Layer 2 Boundary Rule

**If you are a PO/PM authoring a ticket, leave the Technical Notes section blank.**

Layer 2 content (Repos, Files, API Contracts, Config Changes, Error Messages,
Data Model, Root Cause, Fix Summary) is populated by the developer or AI agent
DURING implementation — not at ticket creation.

Populating Layer 2 at creation risks propagating incorrect technical assumptions
(wrong file paths, outdated API contracts, hallucinated repos) as ground truth
to the dev and tester AI downstream.

**AI agents:** If the user asks you to populate Technical Notes at ticket
creation, pause and ask whether they are the developer implementing the work
or the PO authoring it. Proceed with Layer 2 only if they confirm developer
context or post-investigation population. See `jira-agent-workflow.md` for
the full behavior rule.
...
<!-- Paste or link supporting materials: HTML mockups, CSV samples, PDF specs, screenshots, Figma exports -->
- [document description]: [link or inline content]
...
---
<!-- Layer 2 — see "Layer 2 Boundary Rule" at top. Leave blank if PO/PM at creation. -->
...
- **Application:** App One Portal / App One Services / App Two Portal
